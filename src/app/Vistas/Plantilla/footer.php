    ...
    <div class="mx-auto max-w-7xl">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 2xl:grid-cols-6 gap-8 py-10 ">
            <div class="col-span-full mb-10 2xl:col-span-2 lg:mb-0 flex items-center flex-col 2xl:items-start">
                <a href="/inicio" class="flex justify-center lg:justify-start">
                ...
                <div class="flex items-center justify-between w-full max-w-xl mx-auto flex-col  2xl:flex-col 2xl:items-start">
                    <p class="2xl:py-8 py-4 text-sm text-gray-500 2xl:max-w-xs text-center lg:text-left">Tu biblioteca de videojuegos personalizada. Más de 5 millones de jugadores organizan y descubren nuevas aventuras cada día. ¿Necesitas ayuda?</p>
                    <a href="/contacto" class="py-2 px-5 block w-fit bg-indigo-600 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0"> Contacta con nosotros </a>
                </div>
            </div>
            <!--End Col-->
            <!--End Col-->
            <div class="lg:mx-auto text-left">
                <h4 class="text-lg text-gray-900 font-medium mb-7">Sobre Game Shelf</h4>
                <ul class="text-sm transition-all duration-500">
                    <li class="mb-6">
                        <a href="/inicio" class="text-gray-600 text-sm font-normal hover:text-gray-900">Inicio</a>
                    </li>
                    <li class="mb-6">
                        <a href="/acercaDe" class="text-gray-600 text-sm font-normal hover:text-gray-900">Acerca de</a>
                    </li>
                    <li class="mb-6">
                        <a href="/prensa" class="text-gray-600 text-sm font-normal hover:text-gray-900">Prensa</a>
                    </li>
                    <li>
                        <a href="/informes" class="text-gray-600 text-sm font-normal hover:text-gray-900">Informes anuales</a>
                    </li>
                </ul>
            </div>
            <!--End Col-->
            <div class="lg:mx-auto text-left">
                <h4 class="text-lg text-gray-900 font-medium mb-7">Legal</h4>
                <ul class="text-sm transition-all duration-500">
                    <li class="mb-6">
                        <a href="/privacidad" class="text-gray-600 text-sm font-normal hover:text-gray-900">Política de privacidad</a>
                    </li>
                    <li class="mb-6">
                        <a href="/terminosServicio" class="text-gray-600 text-sm font-normal hover:text-gray-900">Términos de servicio</a>
                    </li>
                    <li class="mb-6">
                        <a href="/seguridad" class="text-gray-600 text-sm font-normal hover:text-gray-900">Seguridad</a>
                    </li>
                    <li>
                        <a href="/cookies" class="text-gray-600 text-sm font-normal hover:text-gray-900">Política de cookies</a>
                    </li>
                </ul>
            </div>
            <!--End Col-->
            <div class="lg:mx-auto text-left">
                <h4 class="text-lg text-gray-900 font-medium mb-7">Ayuda</h4>
                <ul class="text-sm transition-all duration-500">
                    <li class="mb-6">
                        <a href="/preguntas" class="text-gray-600 text-sm font-normal hover:text-gray-900">Preguntas frecuentes</a>
                    </li>
                    <li class="mb-6">
        ...
        <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span class="text-sm text-gray-500 ">© <a href="https://pagedone.io/">&#10084; Spoti</a> 2025, Todos los derechos reservados.</span>
