        ...
        <div class="w-full flex flex-col lg:flex-row">
            ...
            <div class="hidden w-full lg:flex lg:pl-11 max-lg:mt-1 max-lg:overflow-y-auto" id="navbar">
                <ul class="flex lg:items-center lg:justify-center flex-col lg:gap-6 gap-4 max-lg:pt-4 max-lg:mb-4 lg:mt-0 lg:flex-row lg:mx-auto ">
                    <li>
                        <a href="javascript:;" class="nav-link block lg:px-2 lg:text-left text-base text-gray-900 font-medium transition-all duration-500 hover:text-gray-500">Inicio</a>
                    </li>
                    <li>
                        <a href="javascript:;" class="nav-link block lg:px-2 lg:text-left text-gray-900 text-base font-medium transition-all duration-500 hover:text-gray-500">Sobre Nosotros</a>
                    </li>
                    <li class="relative">
                        <button data-target="menu1" class="dropdown-toggle flex items-center justify-between text-gray-900 text-center text-base font-medium transition-all duration-500 lg:px-2 mr-auto lg:text-left lg:m-0 hover:text-gray-500">
                            Products
                                    ...
                                    <li class="">
                                        <a href="javascript:;" class="px-3 py-5 hover:bg-gray-50 hover:rounded-xl flex items-center transition-all duration-500">
                                            ...
                                            <div class="ml-4 w-4/5">
                                                <h5 class="text-gray-900 text-base mb-1.5 font-semibold">
                                                    Analytics
                                                    <span class="bg-indigo-50 text-indigo-500 text-xs font-medium mr-2 px-2.5 py-1 rounded-full h-5 ml-4">New</span>
                                                </h5>
                                                <p class="text-xs font-medium text-gray-400">
                    ...
                    <li class="relative">
                        ...
                        <div id="menu2" aria-labelledby="menu2" class="dropdown-menu z-10 relative top-3 max-lg:mb-3 lg:absolute lg:top-14 font-normal bg-white rounded-lg shadow-md shadow-gray-200 w-64 xl:p-8 lg:p-4 p-2 hidden">
                            <ul class="text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                                ...
                                <li>
                                    <a href="javascript:;" class="block py-3 hover:text-prime-blue-700 text-base text-gray-900 font-semibold transition-all duration-500">Notification</a>
                                </li>
                                <li>
                                    <a href="javascript:;" class="block py-3 hover:text-prime-blue-700 text-base text-gray-900 font-semibold transition-all duration-500">Analytics</a>
                                </li>
                                <li>
                                    <a href="javascript:;" class="block py-3 hover:text-prime-blue-700 text-base text-gray-900 font-semibold transition-all duration-500">Integrations</a>
                                </li>
                                <li>
                                    <a href="javascript:;" class="block py-3 hover:text-prime-blue-700 text-base text-gray-900 font-semibold transition-all duration-500">Security</a>
                                </li>
                                <li>
                                    <a href="javascript:;" class="block py-3 hover:text-prime-blue-700 text-base text-gray-900 font-semibold transition-all duration-500">Documentation</a>
                                </li>
                                <li>
                                    <a href="javascript:;" class="block py-3 hover:text-prime-blue-700 text-base text-gray-900 font-semibold transition-all duration-500">Support</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                ...
                <div class="flex lg:items-center w-full justify-start flex-col lg:flex-row lg:w-max gap-5 lg:ml-14 lg:justify-end">
                    <button class="bg-indigo-50 text-indigo-500 rounded-full cursor-pointer leading-6 font-medium text-center transition-all duration-500 py-2 px-5 text-sm hover:bg-indigo-100">
                        Iniciar Sesión
                    </button>
                    <button class="bg-indigo-500 text-white rounded-full cursor-pointer leading-6 font-medium text-center shadow-xs transition-all duration-500 py-2 px-5 text-sm hover:bg-indigo-600">
                        Registrarse
                    </button>
                </div>
            </div>
